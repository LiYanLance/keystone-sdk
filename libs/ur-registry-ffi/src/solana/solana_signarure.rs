...
export! {
	...
	fn parse_sol_signature(
        ...
        let request_id = hex::encode(sol_signature.get_request_id().unwrap());
...
mod tests {
    ...
    fn test_parse() {
        ...
        let expect_result = "{\"request_id\":\"9b1deb4d3b7d4bad9bdd2b0d7b3dcb6d\",\"signature\":\"d4f0a7bcd95bba1fbb1051885054730e3f47064288575aacc102fbbf6a9a14daa066991e360d3e3406c20c00a40973eff37c7d641e5b351ec4a99bfe86f335f7\"}";
